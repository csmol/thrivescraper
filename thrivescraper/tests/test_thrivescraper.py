...
def test_topic_2():
    ...
    gh = thrivescraper.GitHub()
    result = gh.search_repositories("topic:optimade")
...
def test_topics(db):
    """Test the topics as from the command line"""
    result = thrivescraper.main("mine-topics", "ab-initio", db=db)
